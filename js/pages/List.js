        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <h2>Changelog:</h2>
                    <br>
                    <p class="extended">March 4th, 2025</p>
                    <br><br>
                    <p><button class="btn-no-cover" @click="selected = 29">Blast Processing v6</button> has been moved from #26 to #30.<br><br>This pushes <button class="btn-no-cover" @click="selected = 28">LIGM8O</button> to #29 spot.</p>
                    </div>
                    <div class="dark-bg">
                    <h2>Guidelines</h2>
                    <br>
